...
public class SMSUtils {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="7e852afbf940141ba2a6df611fb1ec03";
    
    
    //2.发送短信
    public static boolean sendSms(String phoneNum, String identifyCode){
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
            params.put("mobile",phoneNum);//接收短信的手机号码
            params.put("tpl_id",3940);//短信模板ID，请参考个人中心短信模板设置
